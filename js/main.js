...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _fl_functions_fl_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./fl/functions-fl.js */ "./src/js/fl/functions-fl.js");
...
/* 1 Модуль работы со спойлерами */
//functionsFl.spollers();

/* 2 Функции работы скроллом. Плавная навигация по странице */
//import * as scrollFl from "./fl/scroll-fl.js";
//scrollFl.pageNavigation();

/* 3 Наблюдатель за объектами c атрибутом data-watch */
//import "./fl/watcher-fl.js";

/* 4 Попапы */
//import "./fl/popup-fl.js";

/* 5 Модуль работы с табами */
//functionsFl.tabs();

/* 7 Модуль для работы с меню (Бургер) */
//functionsFl.menuInit();

/* 8 Модуль параллакса мышью <div data-prlx-mouse*/
//import './fl/parallax-mouse.js'

/* 9 Функционал добавления классов к хедеру при прокрутке */
//scrollFl.headerScroll();

/* 10 Select */
//import "./fl/select-fl.js";

/* Учет плавающей панели на мобильных устройствах при 100vh */
// flsFunctions.fullVHfix();

//video-button
const videoBlock = document.querySelector('.current__video');
if (videoBlock) {
  const video = videoBlock.querySelector('video');
  const playBtn = videoBlock.querySelector('.current__btn');
  playBtn.addEventListener('click', () => {
    videoBlock.classList.add('current__video--played');
    video.play();
    video.controls = true;
    playBtn.classList.add('current__btn--played');
  });
  video.onpause = function () {
    videoBlock.classList.remove('current__video--played');
    video.controls = false;
    playBtn.classList.remove('current__btn--played');
  };
}
